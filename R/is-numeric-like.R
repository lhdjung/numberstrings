...
#'   numeric" by the particular standards of numberstrings. This means:
#'
...
#'
#' @details The numberstrings package is all about strings that can be coerced
#'   to numeric without introducing new `NA`s. This is a matter of displaying
#'   data in a certain way, as opposed to their storage mode.
#'
